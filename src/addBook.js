    ...
    const handleSubmit=(e)=> { 
        ...
        .then(data => {
            if (data.error) {
                ...
                navigate('/recommendations', { state: { results: data.recommendations, inputTitles: data.input_titles } });
                setError('')
            }
        })
        .catch(error => {
    ...
    return (
        <div className='name'>
            <form onSubmit={handleSubmit}>
                <label>Please enter 3 books that you've enjoyed reading:</label>
